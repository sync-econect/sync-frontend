...
import { LayoutDashboard, Database, ArrowLeftRight, CheckCircle2, Package, Send, FileText } from "lucide-react"
      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-16 items-center border-b border-sidebar-border px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-sidebar-foreground">e-Sfinge</span>
        ...
        <div className="border-t border-sidebar-border p-4">
          <div className="rounded-lg bg-sidebar-accent p-3">
            <p className="text-xs text-sidebar-accent-foreground/70">Versão 1.0.0 - POC</p>
          </div>
        </div>
      </div>
    </aside>
